...
export var SampleAppUtilities = (function(): any {
  var vocalGuidanceSoundFilesDirectory = "../assets/sample-app-resources/Vocal_Guidance_Audio_Files/";
  ...
  function disableAllButtons(): void {
    (document.getElementById("enrollment-button") as HTMLElement).setAttribute("disabled", "true");
    (document.getElementById("phoid-button") as HTMLElement).setAttribute("disabled", "true");
  ...
  function enableAllButtons(): void {
    (document.getElementById("enrollment-button") as HTMLElement).removeAttribute("disabled");
    (document.getElementById("phoid-button") as HTMLElement).removeAttribute("disabled");
